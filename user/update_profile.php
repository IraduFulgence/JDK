...
$query="update user set name='$n',mobile='$mob',gender='$gen',level='$level',dob='$dob' where email='".$_SESSION['user']."'";
	...
	<Tr>
		<Td colspan="2"><?php echo @$err;?></Td>
				...
				<tr>
					...
					<Td>
					Level 1<input type="radio" <?php if($res['level']=="Level1"){echo "checked";} ?> name="level" value="Level1"/>
				Level 2<input type="radio" <?php if($res['level']=="Level2"){echo "checked";} ?> name="level" value="Level2"/>	
				Level 3<input type="radio" <?php if($res['level']=="Level3"){echo "checked";} ?> name="level" value="Level3"/>	
