...
<div class="container">
	...
	<div class="row">
		<div class="col-sm-8 col-sm-offset-2">
			...
			?>
			<form method="POST" action="../pages/save_cart.php">
			<table class="table table-bordered table-striped">
				...
				<tbody>
					<?php
						...
						//connection
						$conn = new mysqli('localhost', 'root', '', 'online_gallery');
						...
						$sql = "SELECT * FROM art WHERE id IN (".implode(',',$_SESSION['cart']).")";
			...
			<a href="../pages/clear_cart.php" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Clear Cart</a>
			<a href="..pages/checkout.php" class="btn btn-success"><span class="glyphicon glyphicon-check"></span> Checkout</a>
			</form>
		</div>
	</div>
</div>
